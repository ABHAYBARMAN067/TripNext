        ...
        <div className="space-y-6">
            ...
            {bookings.length === 0 ? (
                <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">Your listings haven't received any bookings yet</p>
                </div>
            ) : (
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className={`inline-block px-3 py-1 text-sm rounded-full ${booking.status === 'confirmed' ? 'bg-green-100 text-green-800' :
