        ...
        debounce((query: string) => {
            if (pathname === '/') {
                ...
                if (query !== currentSearch) {
                    const newUrl = query.trim() ? `/?search=${encodeURIComponent(query)}` : '/';
        ...
        <header className="bg-white shadow-sm border-b sticky top-0 z-50">
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    {/* Search Bar */}
                    <form onSubmit={handleSearch} className="flex-1 max-w-md mx-4 hidden sm:block" suppressHydrationWarning>
                    ...
                    <nav className="hidden md:flex items-center space-x-6">
                        <Link href="/" className="text-gray-700 hover:text-blue-600 transition-colors font-medium px-3 py-2 rounded-md hover:bg-blue-50">
                            Home
                        </Link>
                        {session?.user?.role === 'host' ? (
                            <Link href="/host/dashboard" className="text-gray-700 hover:text-blue-600 transition-colors font-medium px-3 py-2 rounded-md hover:bg-blue-50">
                                Dashboard
                            </Link>
                        ) : (
                            <Link href="/host/listings/new" className="text-gray-700 hover:text-blue-600 transition-colors font-medium px-3 py-2 rounded-md hover:bg-blue-50">
                                Become a Host
                            </Link>
                        )}
                        {session ? (
                            ...
                            <Link href="/login" className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors font-medium">
                                Sign In
                            </Link>
                        )}
                    </nav>
